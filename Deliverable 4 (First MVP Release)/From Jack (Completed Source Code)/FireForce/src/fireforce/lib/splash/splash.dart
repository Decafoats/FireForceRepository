            ...
            children: <Widget>[
              ...
              Padding(
                  ...
                  child: Container(width: MediaQuery.of(context).size.width / 1.1, child:Text(
                    'Fire force is a fire safety application for kids. Kids will learn how to call 911 and know what to expect and say when talking to the emergency operators.',
                    style: TextStyle(
                      letterSpacing: 2,
                      color: Colors.white,
                      fontSize: 20,
